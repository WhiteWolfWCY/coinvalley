...
export const AccountFilter = () => {
  ...
  const { isLoading: isLoadingSummery } = useGetSummary();

  const { data: accounts, isLoading: isLoadingAccoutns } = useGetAccounts();
  ...
  return (
    <Select
      ...
      disabled={isLoadingAccoutns || isLoadingSummery}
    >
